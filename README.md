...
## Scatter plot showing the relationship of model-based metrics NDCG@10 (relativa change),  Jaccard@10 (after chuffle) for GRU4Rec and SASRec with 2-grams of sequential rules (relativa change).
